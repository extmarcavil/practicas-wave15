package ar.com.alehenestroza.apicodigomorse.controllers;
...
public class CodigoMorseController {
    ...
    @GetMapping("/api/morse/{codigo}")
    public String convertirAMorse(@PathVariable String codigo) {
        ...
        for (String palabra : palabrasMorse) {
            ...
            for (String letra : letrasMorse) {
                sb.append(caracteres.get(letra));
            }
            sb.append(" ");
        }
//        StringBuilder sb = new StringBuilder();
