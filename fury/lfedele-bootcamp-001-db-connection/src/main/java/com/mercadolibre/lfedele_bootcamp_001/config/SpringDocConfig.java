package com.mercadolibre.lfedele_bootcamp_001.config;

import static com.mercadolibre.lfedele_bootcamp_001.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.lfedele_bootcamp_001.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("lucas fedele")
                .email("lucas.fedele@mercadolibre.com"));
