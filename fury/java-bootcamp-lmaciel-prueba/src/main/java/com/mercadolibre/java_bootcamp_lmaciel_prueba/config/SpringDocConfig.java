package com.mercadolibre.java_bootcamp_lmaciel_prueba.config;

import static com.mercadolibre.java_bootcamp_lmaciel_prueba.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.java_bootcamp_lmaciel_prueba.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("lorena maciel")
                .email("lorena.maciel@mercadolibre.com"));
