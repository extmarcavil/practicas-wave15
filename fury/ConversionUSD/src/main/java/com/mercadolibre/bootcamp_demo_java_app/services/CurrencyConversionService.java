...
public class CurrencyConversionService {
	...
	public Double getCurrencyConversionRatioToUSD(CurrencyEnum sourceCurrency) throws ParseException, RestException {
		CurrencyConversionDTO resp = currencyConversionApiService.getCurrencyConversion(sourceCurrency, CurrencyEnum.USD);
		if (log.isDebugEnabled()) {
			log.debug("Item info lookup: {}",resp);
		}
		return resp.getRatio(); //UNIMPLEMENTED
	}
