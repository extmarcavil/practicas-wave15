...
import static com.mercadolibre.bootcamp_api_deportistas.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.bootcamp_api_deportistas.util.ScopeUtils.isLocalScope;
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                ...
                .email("alejandro.henestroza@mercadolibre.com"));
