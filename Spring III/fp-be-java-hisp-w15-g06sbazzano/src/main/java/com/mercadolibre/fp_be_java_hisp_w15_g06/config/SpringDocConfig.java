...
import static com.mercadolibre.fp_be_java_hisp_w15_g06.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.fp_be_java_hisp_w15_g06.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("ext_marmarqu")
                .email("ext_marmarqu@mercadolibre.com"));
