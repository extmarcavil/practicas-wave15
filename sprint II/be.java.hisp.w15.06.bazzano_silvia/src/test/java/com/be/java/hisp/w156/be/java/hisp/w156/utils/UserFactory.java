...
public class UserFactory {
    ...
    public static User otherUserCountFollowers() {
        ArrayList<User> listUserFollowers = new ArrayList<>();
        listUserFollowers.add(new User(2, "Pepe", new ArrayList<>(), new ArrayList<>(), new ArrayList<>()));
        listUserFollowers.add(new User(1, "Pepe", new ArrayList<>(), new ArrayList<>(), new ArrayList<>()));

        return new User(2, "Moni2", new ArrayList<>(), listUserFollowers, new ArrayList<>());
    }
