...
public class T0001 {
    ...
    @Test
    @DisplayName("Lanza excepción si se quiere seguir a si mismo")
    void testIdsCantBeEquals() {
        // Arrange
        int userId1 = 1;
        int userId2 = 1;

        User user = new User(userId1, "nombre1");
        User userTwo = new User(userId2, "nombre2");

        // Act & Assert
        Assertions.assertThrows(EqualsIDException.class, () -> service.follow(1,1));
    }
}
