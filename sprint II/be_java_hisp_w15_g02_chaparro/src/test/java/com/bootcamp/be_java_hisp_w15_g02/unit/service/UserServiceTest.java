...
public class UserServiceTest {
    ...
    void verifyOrderTypeExists(){
        ...
        //Assertions.assertDoesNotThrow(() -> userService.getFollowedByUser(5,orderExpected.get(1)));
    }
    ...
    @Test
    @DisplayName("Verify if a user can't follow a not seller user.")
    void verifyCanNotFollowANotSeller(){
        //Arrange
        List<GetFollowersDTO> listExpected = Global.getListSorted("");
        User user = Global.getUserByIdUtils(5);
        //Act and Assert
        Assertions.assertThrows(NotSellerException.class, () -> userService.follow(1,3));
    }
}
