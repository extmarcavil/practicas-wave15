...
public class UserRepositoryTest {
    ...
    @Test
    @DisplayName("Verify if the user to follow is already follow ")
    public void verifyUserToFollowAlreadyFollowError(){
        //act and assert
        Assertions.assertThrows(FollowYourselfException.class, () -> userRepository.follow(1, 5));
    }
    ...
    @Test
    @DisplayName("Verify if the user to unfollow exist ")
    ...
    @Test
    @DisplayName("Verify if the user to unfollow exist error ")
