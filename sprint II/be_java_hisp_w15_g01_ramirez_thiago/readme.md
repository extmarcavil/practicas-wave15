...
##Autor: Thiago Ramirez

###Test de integracion
- Se testea el correcto funcionamiento del modulo en el que un usuario puede seguir solamente a otro usuario que sea vendedor
- Se testea el correcto funcionamiento del modulo en el que un usuario no puede seguir a un usuario que no es vendedor


##El coverage alcanzado es del 83%
