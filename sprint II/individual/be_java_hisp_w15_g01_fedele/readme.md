...
- test_01_follow(): Testea poder seguir a un vendedor (a nivel repo) (US 1)

UserServiceTest.java ->
- test_01_followService(): Testea poder seguir a un vendedor (a nivel service con mocks) (US 1)
- test_01_followUnexistentUser(): Testea que seguir a un usuario inexistente levante Excepcion (service con mocks) (US 1)
