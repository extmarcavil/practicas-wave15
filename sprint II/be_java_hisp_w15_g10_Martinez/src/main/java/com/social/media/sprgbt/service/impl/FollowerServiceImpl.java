...
public class FollowerServiceImpl implements IFollowerService {
    ...
    public FollowerDto createFollower(FollowerDto followerDto) throws ExistingException {
        ...
        Follower existingFollower = followerRepository.getFollowerByUserIdAndUserIdToFollow(entityFollower.getUserId(),
                entityFollower.getUserIdToFollow());
    ...
    public Integer getCountFollowersBySeller(Integer userIdToFollow) {
        ...
        List<Follower> listFollowersBySeller =
                followerRepository.getListFollowersBySeller(userIdToFollow);
    ...
    public List<FollowerDto> getListFollowedByUser(Integer userId) {
        ...
        List<Follower> listFollowedByUser =
                followerRepository.getListFollowedByUser(userId);
