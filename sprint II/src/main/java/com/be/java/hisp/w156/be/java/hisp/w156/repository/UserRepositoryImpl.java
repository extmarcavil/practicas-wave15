...
public class UserRepositoryImpl implements IUserRepository {
    ...
    private void initData() {
        ...
        List<Post> posts = Stream.of(
                new Post(1, LocalDate.now().minusDays(5), product, "100", 500.50),
                new Post(1, LocalDate.now().minusDays(4), product, "100", 600.50)
        ).collect(Collectors.toList());

        List<Post> posts2 = Stream.of(new Post(1, LocalDate.now(), product, "150", 100.50))
                .collect(Collectors.toList());
