...
public class UserRepository implements IUserRepository{
    private static Map<Integer, User> database;
    ...
    public static void initDatabase(){
        ...
        product = new Product(11, "Seca ropas", "Electrodomesticos", "Samsung", "Negro", "");
        post = new Post(LocalDate.now().minusDays(13), product, 2, 100000d);
        user2.newPost(post);

        product = new Product(3, "Aire Acondicionado", "Electrodomesticos", "LG", "Blanco", "");
        post = new Post(LocalDate.of(2022, Month.APRIL, 20), product, 3, 87000d);
        user3.newPost(post);
        ...
        post = new Post(LocalDate.now(), product, 2, 100000d);
        user3.newPost(post);
