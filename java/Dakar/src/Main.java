...
public class Main {
    public static void main(String[] args) {
        ...
        SocorristaMoto soccoristaSanti =  new SocorristaMoto();
        SocorristaAuto socorristaVitaleNicolas = new SocorristaAuto();
        Carrera carrera = new Carrera(200, 100000, "Dakar 2022",5, socorristaVitaleNicolas, soccoristaSanti);
