package EjercicioPracticoGenericsWrapperLambdaStrem;

import EjercicioPracticoGenericsWrapperLambdaStrem.Garage;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Otra Opcion
        // listaVehiculosOrdenadaMarcayPrecio = listaVehiculos.stream().sorted(Comparator.comparing(EjercicioPracticoGenericsWrapperLambdaStrem.Vehiculo::getMarca).thenComparing(EjercicioPracticoGenericsWrapperLambdaStrem.Vehiculo::getCosto)).collect(Collectors.toList());
