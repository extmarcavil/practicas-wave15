  ...
  public static void main(String[] args) {
    ...
    for (int i = 1; i < temperaturas.length; i++) {
      if (temperaturas[i][0] < tempMenor) {
        ...
        indiceCiudadMenorTemp = i;
      }
      if (temperaturas[i][1] > tempMayor) {
        tempMayor = temperaturas[i][1];
        indiceCiudadMayorTemp = i;
      }
    }

    System.out.println("Ciudad con menor temperatura: " + ciudades[indiceCiudadMenorTemp]);
    System.out.println("Ciudad con mayor temperatura: " + ciudades[indiceCiudadMayorTemp]);
