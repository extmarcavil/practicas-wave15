...
public interface IUserRepository {
     ...
     *
     * @param id del usuario
     * @return cantidad de productos publicados en promocion
     */
    int cantProductPromo(int id);

    /**
     *
     * @param userID del usuario
     * @return lista de post de productos en promocion del usuario solicitado
     */
    List<Post> getListProductsPromo( int userID);
