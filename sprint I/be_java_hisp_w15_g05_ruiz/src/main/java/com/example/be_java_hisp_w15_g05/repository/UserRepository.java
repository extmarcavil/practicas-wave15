...
public class UserRepository implements IUserRepository {
    ...
    public UserRepository() {
        User galperin = new User(0, "Marcos Galperin", true);
        ...
        Post posteo = new Post(0,20,LocalDate.of(2022,4,28),null,100,202.00,true,0);

        Post posteo2 = new Post(0,21,LocalDate.of(2022,4,28),null,100,202.00,true,0.10);
        Post posteo3 = new Post(0,22,LocalDate.of(2022,4,28),null,100,202.00,true,0.10);
        Post posteo4 = new Post(0,23,LocalDate.of(2022,4,28),null,100,202.00,true,0);
    ...
    @Override
    public int cantProductPromo(int id) {
        List<Post> postUser= posts.stream()
                .filter( post -> post.getUserId() == id && post.isHas_promo() )
                .collect(Collectors.toList());
    ...
    @Override
    public List<Post> getListProductsPromo(int id) {
        List<Post> listPostProm= posts.stream()
                .filter( post -> post.getUserId() == id && post.isHas_promo() )
                .collect(Collectors.toList());
        return listPostProm;
    }
