...
public class ApplicationProductController {
     ...
     */
    @PostMapping
    public ResponseEntity<ProductoDto> createProduct(@RequestBody ProductoDto dto) throws ExistingException {
    ...
    public ResponseEntity<CategoryDto> createCategory(@RequestBody CategoryDto dto) throws ExistingException {
     ...
     */
    @PostMapping("/post")
    public ResponseEntity<PostDto> createPost(@RequestBody PostDto postDto) throws NotFoundException {
    ...
    public ResponseEntity<PostDto> createPostInPromo(@RequestBody PostDto postDto) throws NotFoundException {
