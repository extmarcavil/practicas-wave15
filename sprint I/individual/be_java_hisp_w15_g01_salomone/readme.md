...
## End-point: US 12 - All Promo Post
...
## End-point: US 13 - Add products to shopping cart
Poder realizar la acción de “agregar al carrito” productos de los vendedores a los que sigo
### Method: POST
>```
>{{url}}/cart/addProducts/{clientId}/{productId}
>```
...
## End-point: US 14 - Count Promo Post
 Obtener un listado de todos los productos agregados al carrito de un determinado usuario
### Method: GET
>```
>/cart/showProducts/{userId}
>```
