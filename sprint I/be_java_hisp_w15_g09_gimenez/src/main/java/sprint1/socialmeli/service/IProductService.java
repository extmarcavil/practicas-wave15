...
public interface IProductService {
     ...
     * lanza una excepcion del tipo InvalidPostException. Si logra convertir el Post, llama al metodo save de un
     * IPostRepository.
     * @param promoPost PostPromoRequestDTO
     * @return PostId del post creado
     */
    Integer savePromo (PostPromoRequestDTO promoPost);

    /**
     * Recibe un identificador de usuario y primero validará que el usuario exista. En caso que no exista, lo
     * indicará por BAD_REQUEST.
     * Si el usuario existe, traera desde IPostRepository la cantidad de productos en promoción del user.
     * @param userId
     * @return
     */
    Integer countPromo (Integer userId);
