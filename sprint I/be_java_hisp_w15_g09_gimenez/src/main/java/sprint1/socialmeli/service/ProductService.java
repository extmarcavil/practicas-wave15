...
public class ProductService implements IProductService {
    ...
    @Override
    public Integer savePromo(PostPromoRequestDTO promoPostDTO) {
        Post newPromoPost = new Post(promoPostDTO);
    ...
    @Override
    public Integer countPromo (Integer userId) {
        existUser(userId, "El usuario de ID");
        return postRepository.countPromoPostOfUser(userId);
    }
