...
import sprint1.socialmeli.dto.TopUserDTO;
...
public interface ISocialMeliService {
    ...
    /**
     * Retorna el top 3 de vendedores con mas seguidores.
     * Para ello trae de ISocialMeliRepository a todos los usuarios, convierte el HashMap a un ArrayList,
     * de este último, elimina a los usuarios que no poseen seguidores, y la recorta al top 3 con más seguidores,
     * devolviendo la lista en cuestión.
     * En caso de que ningun vendedor tenga seguidores, devolverá un array vacio.
     * @return List<TopUserDto>
     */
    List<TopUserDTO> getTop3Sellers();
}
