...
public interface ISocialMeliService {
    ...
    void createPostWithPromo(PostWithPromoDTO promo); //Req 10: recibe una publicacion en promoción y devuelve un OK
    DiscountCountDTO countDiscountPost(int userID); //Req 11: devuelve la cantidad de productos en promocion de un vendedor
    DiscountListDTO listDiscountProducts(int userID); //Req 12: devuelve una lista con los productos en promoción de un vendedor
