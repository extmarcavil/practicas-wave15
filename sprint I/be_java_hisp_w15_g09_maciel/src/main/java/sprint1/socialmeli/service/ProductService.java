...
public class ProductService implements IProductService {
    ...
    @Override
    public ResponseCountPromoPostDTO countPromoPost(int userId) {
        User user = getUserFromRepositoryById(userId);
        return new ResponseCountPromoPostDTO(user,postRepository.getListOfProductPostOfUser(userId).size());
    }
