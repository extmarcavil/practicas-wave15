...
## End-point: US 12 - List of promo products
Obtener un listado de todos los productos en promocion de un determinado vendedor
>```
>{{url}}/products/promo-post/list?user_id={userId}
>```
