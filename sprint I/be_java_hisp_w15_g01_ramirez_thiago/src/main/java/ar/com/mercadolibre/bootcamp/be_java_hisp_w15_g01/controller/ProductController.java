...
public class ProductController {
    ...
    public ResponseEntity<ResponseDTO> createProductPromo(@RequestBody PromotionProductsDTO postPromoDTO){
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(service.createPostPromo(postPromoDTO));
    }
    ...
    public ResponseEntity<PromotionProductsCountDTO> howManyPromoProductsHave(@RequestParam Long userId){
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(service.howManyProductsPromoHave(userId));
    }

    @GetMapping("promo-post/list")
    public ResponseEntity<PostPromoListDTO> getListPromoProducts(@RequestParam Long userID){
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(service.getListPromoPost(userID));
    }
