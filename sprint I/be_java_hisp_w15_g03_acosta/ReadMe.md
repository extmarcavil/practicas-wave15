...
| US   | METHOD | SIGN           | RESPONSE                               |
|:-----|--------|----------------|----------------------------------------|
| 0011 | GET   | /products/promo-post/count?user_id={userId} | Status Code 200 <br /> Status Code 400 |
...
| US   | METHOD | SIGN           | RESPONSE                               |
|:-----|--------|----------------|----------------------------------------|
| 0012 | GET   | /products/promo-post/list?user_id={userId} | Status Code 200 <br /> Status Code 400 |
