...
public class GlobalHandlerException {
    ...
    ResponseEntity<ErrorDTO> handlerExceptionRelationInvallid(OrderInvalidException orderInvalid){
        ErrorDTO errorDTO = new ErrorDTO("Error en metodo de orden", orderInvalid.getMessage());
        return new ResponseEntity<>(errorDTO, HttpStatus.NOT_FOUND);
    }
