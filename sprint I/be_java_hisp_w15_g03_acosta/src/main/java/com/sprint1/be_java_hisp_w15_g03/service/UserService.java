...
public class UserService implements IUserService {
    ...
    /**
     * Permitir que un usario realice la acción de “Follow” (seguir) a un determinado vendedor
     * @param userId
     * @param sellerToFollow
     */
    @Override
    ...
    /**
     * Un usuario realiza la acción de “Unfollow” (dejar de seguir) a un determinado vendedor.
     * @param userId
