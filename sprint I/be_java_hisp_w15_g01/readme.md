...
Para testear la parte individual se usó testunit con python.  
Para ejecutarlo usar el comando:  
python runTest.py  
nota: se debe tener alguna versión de python instalado en el sistema.  
nota 2: la definición del test está en la carpeta test.  
note 3: se tomó esta decisión para testear debido a que postman no es comodo para el testing con lector de pantalla.  
...
## End-point: US 12 - bonus 1 - New favorite Post
agregar un producto publicado a favoritos.
### Method: POST
>```
>{{url}}/favorites/add
>```
...
## End-point: US 12 - Count favorites
Obtener la cantidad de favoritos que tiene agregado un usuario
### Method: GET
>```
>{{url}}/favorites/{{user_id}}/count
>```
### Query Params
