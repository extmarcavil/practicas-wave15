...
| US   | METHOD | SIGN         |      Response                                                                               |
|:-----|--------|--------------------|-------------------------------------------------------------------------------|
| 0010 | POST    | /products/promo-post | Status 200<br /> Status 400
...
###**US 0013**
Obtener una lista de todos los vendedores disponibles

| US   | METHOD | SIGN                                                                                                   |
|:-----|--------|--------------------------------------------------------------------------------------------------------|
| 0014 | GET    | /users/sellers |
...
###**US 0014**
Obtener todos los vendedores que venden un producto por ProductID

| US   | METHOD | SIGN                                                                                                   |
|:-----|--------|--------------------------------------------------------------------------------------------------------|
| 0014 | GET    | /users/sellers/{productId} |
