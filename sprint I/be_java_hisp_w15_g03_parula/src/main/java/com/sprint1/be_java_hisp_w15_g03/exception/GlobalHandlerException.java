...
public class GlobalHandlerException {
    ...
    ResponseEntity<ErrorDTO> handlerExceptionProductNotFound(ProductNotFoundException productNotFoundException){
        ErrorDTO errorDTO = new ErrorDTO("Fallo entidad no encontrada", productNotFoundException.getMessage());
        return new ResponseEntity<>(errorDTO, HttpStatus.NOT_FOUND);
    }
