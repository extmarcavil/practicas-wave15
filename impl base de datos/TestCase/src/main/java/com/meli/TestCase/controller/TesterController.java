...
public class TesterController {
    ...
    public ResponseEntity<List<TestCase>> obtenerTodosPorFecha(@RequestParam(value = "last_update")
                                                                   @DateTimeFormat(pattern = "dd-MM-yyyy")
                                                               LocalDate lastUpdate){
        return new ResponseEntity<>(service.obtenerTodosPorFecha(lastUpdate),HttpStatus.OK);
    }
