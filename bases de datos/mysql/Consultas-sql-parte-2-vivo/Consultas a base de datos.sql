...
-- SELECT title, rating, awards, release_date FROM movies WHERE rating > 3 AND awards > 1 and release_date BETWEEN "1998-01-01" AND "2009-12-31" ORDER BY rating DESC;