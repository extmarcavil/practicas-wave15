...
SELECT title AS tituloSerie from movies_db.series AS series;
...
SELECT title FROM movies_db.movies WHERE release_date BETWEEN "2004-1-1" AND "2008"-12-31;
...
WHERE rating > 3 AND awards > 1 AND release_date BETWEEN "1988-1-1" AND "2009-12-31" 
ORDER BY rating;
