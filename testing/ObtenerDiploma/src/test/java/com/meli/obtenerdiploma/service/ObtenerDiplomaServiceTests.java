...
public class ObtenerDiplomaServiceTests {
    ...
    @Test
    @DisplayName("Cálculo del Promedio")
    ...
    public void averageScoreOver9MessageWellWritten() {
        ...
        // assert
        verify(studentDAO, atLeastOnce()).findById(stu.getId());
        assertEquals(9.0, stu.getAverageScore());
    ...
    @Test
    @DisplayName("Datos de Salida idénticos a datos de Entrada (Nombre)")
    ...
    @Test
    @DisplayName("Datos de Salida idénticos a datos de Entrada (Materias)")
