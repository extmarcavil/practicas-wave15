...
public class CurrencyConversionService {
	...
	public Double getCurrencyConversionRatioToUSD(CurrencyEnum sourceCurrency) throws ParseException, RestException {
		CurrencyConversionDTO currConversion = currencyConversionApiService.getCurrencyConversion(sourceCurrency, CurrencyEnum.USD);
		if (log.isDebugEnabled()) {
			log.debug("Currency conversion info: {}",currConversion);
		}
		return currConversion.getRatio();
	}
